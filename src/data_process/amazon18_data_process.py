...
def load_meta_items(file):
    ...
    with gzip.open(file, "r") as fp:
        for line in tqdm(fp, desc="Load metas"):
            ...
            if "title" in data:
                ...
                # print(f"Warning: No title for item {item}: {line}")
                title = ""
                no_title_count += 1
            ...
            if "description" in data:
                ...
                # print(f"Warning: No description for item {item}: {line}")
            ...
            if "brand" in data:
                ...
                brand = ""
                no_brand_count += 1
                # print(f"Warning: No brand for item {item}: {line}")
    ...
    print(f"Items with no title: {no_title_count}")
    print(f"Items with no description: {no_description_count}")
    print(f"Items with no brand: {no_brand_count}")
    print(f"Total items with meta data: {len(items)}")
    return items
