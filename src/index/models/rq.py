...
class ResidualVectorQuantizer(nn.Module):
    ...
    def __init__(self, n_e_list, e_dim, beta, sk_epsilons,
        ...
        print(f"n_e_list: {n_e_list}, sk_epsilons: {sk_epsilons}")
        self.vq_layers = nn.ModuleList([VectorQuantizer(n_e, e_dim, beta,
