...
class Trainer(object):
    ...
    def _train_epoch(self, train_data, epoch_idx):
        ...
        for batch_idx, data in enumerate(iter_data):
            ...
            out, vq_loss, indices = self.model(data)
            loss, loss_recon = self.model.compute_loss(out, vq_loss, target=data)
        ...
        return total_loss, total_recon_loss, total_vq_loss
    ...
    def fit(self, data):
        ...
        for epoch_idx in range(self.epochs):
            ...
            train_loss, train_recon_loss, total_vq_loss = self._train_epoch(data, epoch_idx)
            print(f'epoch {epoch_idx}, total loss: {train_loss}, recon loss: {train_recon_loss}, vq loss: {total_vq_loss}')
